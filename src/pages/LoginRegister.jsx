      ...
      <div className="w-full max-w-5xl mt-[-100px]">
        ...
        <div className="bg-[#1e1e1e] rounded-lg shadow-lg w-full p-8 flex flex-col md:flex-row gap-6">
          ...
          <div className="w-full md:w-1/2">
            ...
            <p className="text-[#e0e0e0] mb-4 text-sm">¿Ya tienes cuenta? Inicia sesión aquí.</p>
          ...
          <div className="w-full md:w-1/2 border-t md:border-t-0 md:border-l border-[#333] pt-6 md:pt-0 md:pl-6">
            <h3 className="text-lg font-bold text-[#ff004c] mb-4">Registrarse</h3>
            <p className="text-[#e0e0e0] mb-6 text-sm">
              Haz clic en el botón y completa el formulario para unirte a nuestra comunidad.
            </p>
            <ul className="text-sm text-[#e0e0e0] space-y-2 mb-6">
              <li>✔ Consigue hasta 30 insignias</li>
              <li>✔ Recibe descuentos y beneficios</li>
              <li>✔ Forma parte de la comunidad</li>
            </ul>
            <button
